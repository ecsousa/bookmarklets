// Bookmarklet URL:
// javascript:(function(){document.body.appendChild(document.createElement('script')).src='https://cdn.rawgit.com/ecsousa/bookmarklets/master/kimble.js';})();
  ...
  $(document).keydown(function(e) {
    if(e.altKey && (e.keyCode == 78 || e.keyCode == 80)) {
      ...
      if(nextField.length == 0) {
        $("input.start-time[row-key='" + rowKey + "'][entry-date='" + current + "']").focus().focusin();
      }
      else {
